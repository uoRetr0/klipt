...
```sh
npm run set-version -- 0.3.5          # bumps tauri.conf.json, package.json, Cargo.toml, Cargo.lock
git commit -am "chore: bump version to 0.3.5"
git push origin main
git tag -a v0.3.5 -m "Klipt 0.3.5" && git push origin v0.3.5
```
