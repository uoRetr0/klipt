...
script per platform downloads a pinned, checksum-verified GPL build into that path
(Windows: Gyan.dev; Linux: BtbN static). Both builds include `libx264` (the universal CPU
